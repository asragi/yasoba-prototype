...
func InitializeProduceCheckInvokeSequence() ProduceCheckInvokeSequence {
	conditionDataPort := createEventConditionDataPortFromYAML("assets/data/event_condition.yaml")
	battleSequenceRelationDataPort := createBattleSequenceRelationDataPortFromYAML("assets/data/battle_sequence_relation.yaml")
	conditionActorHpDataPort := createConditionActorHpDataPortFromYAML("assets/data/condition_actor_hp.yaml")
